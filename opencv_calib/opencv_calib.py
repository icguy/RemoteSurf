...
ret, mtx, dist, rvecs, tvecs = cv2.calibrateCamera(objpoints, imgpoints, (640, 360), flags=cv2.CALIB_FIX_ASPECT_RATIO)
print ret
print mtx
print dist
mean_error = 0
